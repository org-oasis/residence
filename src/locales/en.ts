...
export const en = {
  ...
  apartments: {
    ...
    faq: {
      ...
      a3: "Jeanne D'Arc beach is about a 10-minute walk or a 2-minute drive away.",
      q4: "Is the Wi-Fi fast?",
      a4: "Yes, 240 Mbps fibre with a dedicated modem per floor for better signal distribution and stable speed in every apartment. Ideal for Zoom, streaming and remote work.",
